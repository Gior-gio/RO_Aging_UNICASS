...
C {sky130_fd_pr/corner.sym} 1150 -680 0 0 {name=CORNER only_toplevel=false corner=ff}
C {code_shown.sym} 1160 -480 0 0 {name=s1 only_toplevel=false 
value=
"
.tran 100p 1200n
.ic v(OUT)=100m
...
C {launcher.sym} 300 -870 0 0 {name=h5
descr="load waves" 
...
C {/foss/designs/RO_Aging_UNICASS/HVT/RingOscilator_hvt_101/RingOscilator_hvt_101.sym} 840 -130 0 0 {name=x1}
