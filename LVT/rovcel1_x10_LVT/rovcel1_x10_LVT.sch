...
C {lab_pin.sym} 560 -170 0 1 {name=p11 sig_type=std_logic lab=VDD}
...
C {iopin.sym} 780 -260 0 0 {name=p3 lab=OUT}
C {iopin.sym} 780 -350 0 0 {name=p10 lab=RON



}
C {lab_pin.sym} 780 -130 0 1 {name=p4 sig_type=std_logic lab=RON
}
